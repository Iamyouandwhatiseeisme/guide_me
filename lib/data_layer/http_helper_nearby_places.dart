...
Future<List<NearbyPlacesModel>> fetchData(
    List<NearbyPlacesModel> listOfPlaces, String apiKey) async {
  final url = Uri.parse(
      'https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=41.6938017,44.8015167&radius=8000&type=park|museum&key=$apiKey');
