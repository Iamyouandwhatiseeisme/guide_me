    ...
    return Padding(
      ...
      child: Builder(builder: (context) {
        if (openningHours['open_hour'] != null) {
          return Text(
              '${openningHours['open_hour']!.substring(0, 2)}:${openningHours['open_hour']!.substring(2, 4)}AM -${openningHours['close_hour']!.substring(0, 2)}:${openningHours['close_hour']!.substring(2, 4)}PM');
        } else {
